...
document.addEventListener('DOMContentLoaded', function() {
    ...
    dateInputs.forEach(function(input) {
        ...
        if (!input.closest('.date-wrapper')) {
            ...
            btn.style.cssText = 'position:absolute;right:8px;top:50%;transform:translateY(-50%);border:none;background:transparent;color:var(--ink-3);cursor:pointer;padding:0;z-index:2;line-height:1;min-width:24px;min-height:24px;width:24px;height:24px;display:flex;align-items:center;justify-content:center;';
        ...
        if (parent && !input.id && !parent.querySelector('.date-quick')) {
            ...
            quick.style.cssText = 'display:block;margin-top:4px;font-size:11px;color:var(--info);cursor:pointer;font-weight:600;';
